...
import json
import sys
sys.path.append('/content/drive/MyDrive/ProjectNLP/NLP_Perfect/DrQA')
...
parser.add_argument('--out-dir', type=str, default='/content/drive/MyDrive/ProjectNLP/NLP_Perfect/DrQA/data/datasets',
